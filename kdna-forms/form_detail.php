		...
		<div class="editor-sidebar">
			...
			<aside class="sidebar ui-tabs" role="region" >
				...
				<div class="sidebar__panel sidebar__panel--settings" id="field_settings_container" data-active-field-class="">
					...
					<!-- Rendered by GFConditionalLogic (js/components/form_editor/
					     conditional_flyout/). gatherElements() looks these up by id and
					     builds the panel inside them, so they must exist and stay empty.
					     Removing conditional_logic_flyout_container made addEventListeners
					     bind to null, which threw inside LoadFieldSettings and stopped the
					     sidebar ever switching to Field Settings. -->
