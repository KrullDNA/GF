...
if ( ! class_exists( 'RGCurrency' ) ) {
	...
	class RGCurrency {
		...
		public static function get_currencies() {
			$currencies = array(
				'USD' => array(
					'name'               => esc_html__( 'U.S. Dollar', 'kdnaforms' ),
					'symbol_left'        => '$',
					'symbol_right'       => '',
					'symbol_padding'     => '',
					'thousand_separator' => ',',
				...
				'GBP' => array(
					'name'               => esc_html__( 'Pound Sterling', 'kdnaforms' ),
					'symbol_left'        => '&#163;',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'EUR' => array(
					'name'               => esc_html__( 'Euro', 'kdnaforms' ),
					'symbol_left'        => '',
					'symbol_right'       => '&#8364;',
					'symbol_padding'     => ' ',
					'thousand_separator' => '.',
				...
				'AUD' => array(
					'name'               => esc_html__( 'Australian Dollar', 'kdnaforms' ),
					'symbol_left'        => '$',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'BRL' => array(
					'name'               => esc_html__( 'Brazilian Real', 'kdnaforms' ),
					'symbol_left'        => 'R$',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => '.',
				...
				'CAD' => array(
					'name'               => esc_html__( 'Canadian Dollar', 'kdnaforms' ),
					'symbol_left'        => '$',
					'symbol_right'       => 'CAD',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'CZK' => array(
					'name'               => esc_html__( 'Czech Koruna', 'kdnaforms' ),
					'symbol_left'        => '',
					'symbol_right'       => '&#75;&#269;',
					'symbol_padding'     => ' ',
					'thousand_separator' => ' ',
				...
				'DKK' => array(
					'name'               => esc_html__( 'Danish Krone', 'kdnaforms' ),
					'symbol_left'        => '',
					'symbol_right'       => 'kr.',
					'symbol_padding'     => ' ',
					'thousand_separator' => '.',
				...
				'HKD' => array(
					'name'               => esc_html__( 'Hong Kong Dollar', 'kdnaforms' ),
					'symbol_left'        => 'HK$',
					'symbol_right'       => '',
					'symbol_padding'     => '',
					'thousand_separator' => ',',
				...
				'HUF' => array(
					'name'               => esc_html__( 'Hungarian Forint', 'kdnaforms' ),
					'symbol_left'        => '',
					'symbol_right'       => 'Ft',
					'symbol_padding'     => ' ',
					'thousand_separator' => '.',
				...
				'ILS' => array(
					'name'               => esc_html__( 'Israeli New Sheqel', 'kdnaforms' ),
					'symbol_left'        => '&#8362;',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'JPY' => array(
					'name'               => esc_html__( 'Japanese Yen', 'kdnaforms' ),
					'symbol_left'        => '&#165;',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'MYR' => array(
					'name'               => esc_html__( 'Malaysian Ringgit', 'kdnaforms' ),
					'symbol_left'        => '&#82;&#77;',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'MXN' => array(
					'name'               => esc_html__( 'Mexican Peso', 'kdnaforms' ),
					'symbol_left'        => '$',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'NOK' => array(
					'name'               => esc_html__( 'Norwegian Krone', 'kdnaforms' ),
					'symbol_left'        => 'Kr',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => '.',
				...
				'NZD' => array(
					'name'               => esc_html__( 'New Zealand Dollar', 'kdnaforms' ),
					'symbol_left'        => '$',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'PHP' => array(
					'name'               => esc_html__( 'Philippine Peso', 'kdnaforms' ),
					'symbol_left'        => 'Php',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'PLN' => array(
					'name'               => esc_html__( 'Polish Zloty', 'kdnaforms' ),
					'symbol_left'        => '&#122;&#322;',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => '.',
				...
				'RUB' => array(
					'name'               => esc_html__( 'Russian Ruble', 'kdnaforms' ),
					'symbol_left'        => '',
					'symbol_right'       => 'pyб',
					'symbol_padding'     => ' ',
					'thousand_separator' => ' ',
				...
				'SGD' => array(
					'name'               => esc_html__( 'Singapore Dollar', 'kdnaforms' ),
					'symbol_left'        => '$',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'ZAR' => array(
					'name'               => esc_html__( 'South African Rand', 'kdnaforms' ),
					'symbol_left'        => 'R',
					'symbol_right'       => '',
					'symbol_padding'     => '',
					'thousand_separator' => ',',
				...
				'SEK' => array(
					'name'               => esc_html__( 'Swedish Krona', 'kdnaforms' ),
					'symbol_left'        => '',
					'symbol_right'       => 'Kr',
					'symbol_padding'     => ' ',
					'thousand_separator' => ' ',
				...
				'CHF' => array(
					'name'               => esc_html__( 'Swiss Franc', 'kdnaforms' ),
					'symbol_left'        => 'CHF',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => "'",
				...
				'TWD' => array(
					'name'               => esc_html__( 'Taiwan New Dollar', 'kdnaforms' ),
					'symbol_left'        => '$',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
				...
				'THB' => array(
					'name'               => esc_html__( 'Thai Baht', 'kdnaforms' ),
					'symbol_left'        => '&#3647;',
					'symbol_right'       => '',
					'symbol_padding'     => ' ',
					'thousand_separator' => ',',
			...
			return apply_filters( 'kdnaform_currencies', $currencies );
		}
		...
		public static function get_grouped_currency_options( $placeholder = true, $sort = true ) {
			 ...
			 * want to make sure the custom data that maps to the key is included in the kdnaform_currencies
			 * filter.
			 *
			 * @since 2.7
			 *
			 ...
			 */
			$common_currency_keys = apply_filters( 'kdnaform_common_currencies', array(
				'USD',
				'GBP',
				'EUR',
			) );
			...
			$options = $placeholder ? array(
				array(
					'label' => esc_html__( 'Select a Currency', 'kdnaforms' ),
					'value' => '',
				)
			) : array();
