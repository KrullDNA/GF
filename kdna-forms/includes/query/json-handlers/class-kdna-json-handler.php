...
abstract class GF_JSON_Handler {
	...
	protected function get_setting_name() {
		 ...
		 * @return string
		 */
		return apply_filters( 'kdnaform_full_screen_display_setting_name', self::SETTING_NAME );
	}
	...
	protected function get_section_name() {
		 ...
		 * @return string
		 */
		return apply_filters( 'kdnaform_full_screen_display_setting_group', self::SECTION_NAME );
	}
