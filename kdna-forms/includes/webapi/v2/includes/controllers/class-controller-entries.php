...
class KDNA_REST_Entries_Controller extends KDNA_REST_Form_Entries_Controller {
	...
	public function update_item( $request ) {
		...
		$updated_entry = KDNAAPI::get_entry( $entry['id'] );
	...
	public function update_item_permissions_check( $request ) {
		 ...
		 * @param WP_REST_Request $request    Full data about the request.
		 */
		$capability = apply_filters( 'kdnaform_rest_api_capability_put_entries', 'kdnaforms_edit_entries', $request );
	...
	public function delete_item_permissions_check( $request ) {
		 ...
		 * @param WP_REST_Request $request    Full data about the request.
		 */
		$capability = apply_filters( 'kdnaform_rest_api_capability_delete_entries', 'kdnaforms_delete_entries', $request );
