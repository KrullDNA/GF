...
class KDNA_REST_Form_Submissions_Validation_Controller extends KDNA_REST_Controller {
	...
	public function validate_form( $request ) {
		...
		$result = KDNAAPI::validate_form( rgar( $request->get_url_params(), 'form_id' ), $input_values, $field_values, $target_page, $source_page );
