...
class KDNA_Block {
	 ...
	 * @since  2.4.10
	 *
	 * @uses   KDNA_Block::register_block_type()
	 */
	public function init() {
		...
		add_action( 'kdnaform_post_enqueue_scripts', array( $this, 'post_enqueue_scripts' ), 10, 3 );
	 ...
	 * @since  2.4.18
	 *
	 * @deprecated since 2.5.6. See KDNA_Block::register_block_assets()
	 *
