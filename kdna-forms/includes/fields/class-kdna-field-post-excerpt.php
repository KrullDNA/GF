...
class KDNA_Field_Post_Excerpt extends KDNA_Field {

	public $type = 'post_excerpt';

	public function get_form_editor_field_title() {
		return esc_attr__( 'Excerpt', 'kdnaforms' );
	}
	...
	public function get_form_editor_field_description() {
		return esc_attr__( 'Allows users to submit data that is then used as the excerpt of a post.', 'kdnaforms' );
	}
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		return "<div class='kdnainput_container kdnainput_container_post_excerpt'>
	...
	public function get_value_merge_tag( $value, $input_id, $entry, $form, $modifier, $raw_value, $url_encode, $esc_html, $format, $nl2br ) {
		...
		if ( $format === 'html' ) {
			...
			// If $nl2br is true nl2br() may have already been run in KDNACommon::format_variable_value().
			if ( ! $nl2br ) {
...
KDNA_Fields::register( new KDNA_Field_Post_Excerpt() );
