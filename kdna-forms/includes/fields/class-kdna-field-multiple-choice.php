...
class KDNA_Field_Multiple_Choice extends KDNA_Field {

	public $type = 'multi_choice';

	public function get_form_editor_field_title() {
		return esc_attr__( 'Multiple Choice', 'kdnaforms' );
	}
	...
	public function get_form_editor_field_description() {
		return esc_attr__( 'Allow users to choose from a list of options.', 'kdnaforms' );
	}
	...
	public function get_choice_field_select_all_markup( $value, $tabindex, $selected_choices_count ) {
		...
		$select_label  = isset( $this->selectAllText ) ? esc_html( $this->selectAllText ) : esc_html__( 'Select All', 'kdnaforms' );
		...
		$checkbox = new KDNA_Field_Checkbox( $this );
...
KDNA_Fields::register( new KDNA_Field_Multiple_Choice() );
