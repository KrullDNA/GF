...
class KDNA_Field_Text extends KDNA_Field {

	public $type = 'text';

	public function get_form_editor_field_title() {
		return esc_attr__( 'Single Line Text', 'kdnaforms' );
	}
	...
	public function get_form_editor_field_description() {
		return esc_attr__( 'Allows users to submit a single line of text.', 'kdnaforms' );
	}
	...
	public function get_form_editor_field_icon() {
		return 'kform-icon--single-line-text';
	}
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		if ( $this->type === 'post_tags' ) {
			$text_hint = '<p class="kfield_post_tags_hint kfield_description" id="' . $field_id . '_desc">' . kdna_apply_filters( array(
		...
		return sprintf( "<div class='kinput_container kinput_container_text'>%s</div>", $input );
	}
	...
	public function get_aria_describedby( $extra_ids = array() ) {
		...
		if ( ! empty( $this->description ) ) {
			$describedby .= " kfield_description_{$form_id}_{$id}";
		}
...
KDNA_Fields::register( new KDNA_Field_Text() );
