...
class KDNA_Field_Date extends KDNA_Field {
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		if ( $is_form_editor ) {
			...
			$field_string = "<div class='ginput_container ginput_container_date' id='gfield_input_datepicker' style='display:$datepicker_display'><input name='ginput_datepicker' type='text' {$date_picker_placeholder} {$disabled_text} value='{$picker_value}'/><img src='" . KDNACommon::get_base_url() . "/images/datepicker/datepicker.svg' id='gfield_input_datepicker_icon' style='display:$icon_display'/></div>";
