...
class KDNA_Field_Date extends KDNA_Field {
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		if ( $is_form_editor ) {
			...
			if ( $is_sub_label_above ) {
				$month_field = "<div class='kfield_date_month kinput_date kinput_container kinput_container_date kform-grid-col' id='kfield_input_date_month' style='display:$datefield_display'>
                                    <label for='{$field_id}_1' class='kform-field-label kform-field-label--type-sub {$month_sub_label_class}'>{$month_sub_label}</label>
                                    <input id='{$field_id}_1' name='kinput_month' type='text' {$month_placeholder_attribute} {$disabled_text} value='{$month_value}'/>
                                </div>";
				$day_field   = "<div class='kfield_date_day kinput_date kinput_container kinput_container_date kform-grid-col' id='kfield_input_date_day' style='display:$datefield_display'>
                                    <label for='{$field_id}_2' class='kform-field-label kform-field-label--type-sub {$day_sub_label_class}'>{$day_sub_label}</label>
                                    <input id='{$field_id}_2' name='kinput_day' type='text' {$day_placeholder_attribute} {$disabled_text} value='{$day_value}'/>
                               </div>";
				$year_field  = "<div class='kfield_date_year kinput_date kinput_container kinput_container_date kform-grid-col' id='kfield_input_date_year' style='display:$datefield_display'>
                                    <label for='{$field_id}_3' class='kform-field-label kform-field-label--type-sub {$year_sub_label_class}'>{$year_sub_label}</label>
				...
				$year_field  = "<div class='kfield_date_year kinput_date kinput_container kinput_container_date kform-grid-col' id='kfield_input_date_year' style='display:$datefield_display'>
                                    <input type='text' id='{$field_id}_3' name='kinput_year' {$year_placeholder_attribute} {$disabled_text} value='{$year_value}'/>
                                    <label for='{$field_id}_3' class='kform-field-label kform-field-label--type-sub {$year_sub_label_class}'>{$year_sub_label}</label>
                               </div>";
			}

			$month_dropdown = "<div class='kfield_date_dropdown_month kinput_date_dropdown kinput_container kinput_container_date kform-grid-col' id='kfield_dropdown_date_month' style='display:$dropdown_display'>" . $this->get_month_dropdown( '', "{$field_id}_1", rgar( $date_info, 'month' ), '', $disabled_text, $month_placeholder_value ) . '</div>';
			$day_dropdown   = "<div class='kfield_date_dropdown_day kinput_date_dropdown kinput_container kinput_container_date kform-grid-col' id='kfield_dropdown_date_day' style='display:$dropdown_display'>" . $this->get_day_dropdown( '', "{$field_id}_2", rgar( $date_info, 'day' ), '', $disabled_text, $day_placeholder_value ) . '</div>';
			$year_dropdown  = "<div class='kfield_date_dropdown_year kinput_date_dropdown kinput_container kinput_container_date kform-grid-col' id='kfield_dropdown_date_year' style='display:$dropdown_display'>" . $this->get_year_dropdown( '', "{$field_id}_3", rgar( $date_info, 'year' ), '', $disabled_text, $year_placeholder_value, $form ) . '</div>';

			$field_string = "<div class='kinput_container kinput_container_date' id='kfield_input_datepicker' style='display:$datepicker_display'><input name='kinput_datepicker' type='text' {$date_picker_placeholder} {$disabled_text} value='{$picker_value}'/><img src='" . KDNACommon::get_base_url() . "/images/datepicker/datepicker.svg' id='kfield_input_datepicker_icon' style='display:$icon_display'/></div>";
			...
			$field_string .= "<div id='{$field_id}' class='kinput_container kinput_complex kform-grid-row'>{$date_inputs}</div>";
			...
			if ( in_array( $date_type, array( 'datefield', 'datedropdown' ) ) ) {
				...
				switch ( $field_position ) {
					...
					case 'dmy' :
						...
						if ( $date_type == 'datedropdown' ) {
							...
							$field_str = "{$clear_multi_div_open}<div class='kfield_date_dropdown_day kinput_container kinput_container_date kform-grid-col' id='{$field_id}_2_container'>" . $this->get_day_dropdown( "input_{$id}[]", "{$field_id}_2", rgar( $date_info, 'day' ), $tabindex, $disabled_text, $day_placeholder_value, $day_aria_attributes ) . '</div>';

							$tabindex = $this->get_tabindex();
							$field_str .= "<div class='kfield_date_dropdown_month kinput_container kinput_container_date kform-grid-col' id='{$field_id}_1_container'>" . $this->get_month_dropdown( "input_{$id}[]", "{$field_id}_1", rgar( $date_info, 'month' ), $tabindex, $disabled_text, $month_placeholder_value, $month_aria_attributes ) . '</div>';

							$tabindex = $this->get_tabindex();

							$field_str .= "<div class='kfield_date_dropdown_year kinput_container kinput_container_date kform-grid-col' id='{$field_id}_3_container'>" . $this->get_year_dropdown( "input_{$id}[]", "{$field_id}_3", rgar( $date_info, 'year' ), $tabindex, $disabled_text, $year_placeholder_value, $form, $year_aria_attributes ) ."</div>{$clear_multi_div_close}";
						} else {

							$field_str = $is_sub_label_above
								? "{$clear_multi_div_open}
                                        <div class='kfield_date_day kinput_container kinput_container_date kform-grid-col' id='{$field_id}_2_container'>
                                            <label for='{$field_id}_2' class='kform-field-label kform-field-label--type-sub {$day_sub_label_class}'>{$day_sub_label}</label>
							...
							$field_str .= $is_sub_label_above
								? "<div class='kfield_date_month kinput_container kinput_container_date kform-grid-col' id='{$field_id}_1_container'>
                                        <label for='{$field_id}_1' class='kform-field-label kform-field-label--type-sub {$month_sub_label_class}'>{$month_sub_label}</label>
							...
							$field_str .= $is_sub_label_above
								? "<div class='kfield_date_year kinput_container kinput_container_date kform-grid-col' id='{$field_id}_3_container'>
                                            <label for='{$field_id}_3' class='kform-field-label kform-field-label--type-sub {$year_sub_label_class}'>{$year_sub_label}</label>
					...
					case 'ymd' :
						...
						if ( $date_type == 'datedropdown' ) {
							...
							$field_str = "{$clear_multi_div_open}<div class='kfield_date_dropdown_year kinput_container kinput_container_date kform-grid-col' id='{$field_id}_3_container'>" . $this->get_year_dropdown( "input_{$id}[]", "{$field_id}_3", rgar( $date_info, 'year' ), $tabindex, $disabled_text, $year_placeholder_value, $form, $year_aria_attributes ) . '</div>';
							...
							$field_str .= "<div class='kfield_date_dropdown_day kinput_container kinput_container_date kform-grid-col' id='{$field_id}_2_container'>" . $this->get_day_dropdown( "input_{$id}[]", "{$field_id}_2", rgar( $date_info, 'day' ), $tabindex, $disabled_text, $day_placeholder_value, $day_aria_attributes ) . "</div>{$clear_multi_div_close}";
						} else {
					...
					default :
						...
						if ( $date_type == 'datedropdown' ) {
							...
							$field_str = "{$clear_multi_div_open}<div class='kfield_date_dropdown_month kinput_container kinput_container_date kform-grid-col' id='{$field_id}_1_container'>" . $this->get_month_dropdown( "input_{$id}[]", "{$field_id}_1", rgar( $date_info, 'month' ), $tabindex, $disabled_text, $month_placeholder_value, $month_aria_attributes ) . '</div>';

							$tabindex = $this->get_tabindex();

							$field_str .= "<div class='kfield_date_dropdown_day kinput_container kinput_container_date kform-grid-col' id='{$field_id}_2_container'>" . $this->get_day_dropdown( "input_{$id}[]", "{$field_id}_2", rgar( $date_info, 'day' ), $tabindex, $disabled_text, $day_placeholder_value, $day_aria_attributes ) . '</div>';
							...
							$field_str = $is_sub_label_above
								? "{$clear_multi_div_open}<div class='kfield_date_month kinput_container kinput_container_date kform-grid-col' id='{$field_id}_1_container'>
                                            <label for='{$field_id}_1' class='kform-field-label kform-field-label--type-sub {$month_sub_label_class}'>{$month_sub_label}</label>
                                            <input type='{$date_input_type}' {$month_maxlength} name='input_{$id}[]' id='{$field_id}_1' value='{$month_value}' {$tabindex} {$disabled_text} {$month_aria_attributes} {$month_placeholder_attribute} {$month_html5_attributes}/>
                                        </div>"
								: "{$clear_multi_div_open}<div class='kfield_date_month kinput_container kinput_container_date kform-grid-col' id='{$field_id}_1_container'>
				...
				return "<div id='{$field_id}' class='kinput_container kinput_complex kform-grid-row'>$field_str</div>";
			} else {
				...
				return "<div class='kinput_container kinput_container_date'>
                            <input name='input_{$id}' id='{$field_id}' type='text' value='{$picker_value}' class='datepicker kform-datepicker {$format} {$icon_class}' {$tabindex} {$disabled_text} {$date_picker_placeholder} {$describedby_attribute} {$invalid_attribute} {$required_attribute}/>
	 ...
	 *
	 * @since unknown
	 * @since 2.5     Added `screen-reader-text` if the label hasn't been set; added `kfield_label_before_complex` if it is datefield.
	 * @since 2.7     Added `kform-field-label` for the theme framework.
	 *
	 * @return string
	 */
	public function get_field_label_class() {
		$class = 'kfield_label';
		$class .= ' kform-field-label';

		// Added `screen-reader-text` if the label hasn't been set.
		$class .= ( rgblank( $this->label ) ) ? ' screen-reader-text' : '';

		// Added `kfield_label_before_complex` if it is datefield.
		$class .= $this->dateType === 'datefield' ? ' kfield_label_before_complex' : '';
	...
	public function get_field_css_class() {
		...
		$class .= sprintf( ' kfield--input-type-%s', $this->dateType );

		if ( $this->dateType === 'datepicker' ) {
			switch( $this->calendarIconType ) {
				case 'calendar':
					$class .= ' kfield--datepicker-default-icon';
					break;
				case 'custom':
					$class .= ' kfield--datepicker-custom-icon';
					break;
				case 'none':
					$class .= ' kfield--datepicker-no-icon';
					break;
				default:
					break;
			}
	...
	private function get_dropdown_label( $id, $placeholder ) {
		return "<label for='{$id}' class='kform-field-label kform-field-label--type-sub hidden_sub_label screen-reader-text'>{$placeholder}</label>";
	}
	...
	public function get_filter_settings() {
		...
		$filter_settings['cssClass']    = 'datepicker kform-datepicker ymd_dash';
