...
class KDNA_Field_SingleShipping extends KDNA_Field {
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		return "<div class='kinput_container kinput_container_singleshipping'>
					<input type='text' readonly class='kinput_shipping_price kform-text-input-reset' id='{$field_id}' name='input_{$id}' value='{$price}' />
				</div>";
	}
	...
	public function get_value_default() {
		$value = $this->is_form_editor() ? $this->defaultValue : KDNACommon::replace_variables_prepopulate( $this->defaultValue );
		if( rgblank( $value ) ) {
...
KDNA_Fields::register( new KDNA_Field_SingleShipping() );
