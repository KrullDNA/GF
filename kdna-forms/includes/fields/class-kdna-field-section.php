...
class KDNA_Field_Section extends KDNA_Field {

	public $type = 'section';

	public function get_form_editor_field_title() {
		return esc_attr__( 'Section', 'kdnaforms' );
	}
	...
	public function get_form_editor_field_description() {
		return esc_attr__( 'Adds a content separator to your form to help organize groups of fields. This is a visual element and does not collect any data.', 'kdnaforms' );
	}
...
KDNA_Fields::register( new KDNA_Field_Section() );