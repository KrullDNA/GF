...
class KDNA_Field_Website extends KDNA_Field {

	public $type = 'website';

	public function get_form_editor_field_title() {
		return esc_attr__( 'Website', 'kdnaforms' );
	}
	...
	public function get_form_editor_field_description() {
		return esc_attr__( 'Allows users to enter a website URL.', 'kdnaforms' );
	}
	...
	public function validate( $value, $form ) {
		...
		if ( ! empty( $value ) && ! KDNACommon::is_valid_url( $value ) ) {
			$this->failed_validation  = true;
			$this->validation_message = empty( $this->errorMessage ) ? esc_html__( 'Please enter a valid Website URL (e.g. https://kdnaforms.com).', 'kdnaforms' ) : $this->errorMessage;
		}
	}
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		return "<div class='kinput_container kinput_container_website'>
	...
	public function get_value_entry_detail( $value, $entry = array(), $use_text = false, $format = 'html', $media = 'screen' ) {
		...
		return KDNACommon::is_valid_url( $value ) && $format == 'html' ? "<a href='$safe_value' target='_blank'>$safe_value</a>" : $safe_value;
	}
...
KDNA_Fields::register( new KDNA_Field_Website() );
