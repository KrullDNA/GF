...
class Field_Map extends Generic_Map {
	...
	public function save_field( $field_values, $field_value ) {
		...
		// Decode field value.
		$field_value = KDNACommon::maybe_decode_json( $field_value );
...
Fields::register( 'field_map', '\KDNA_Forms\KDNA_Forms\Settings\Fields\Field_Map' );
