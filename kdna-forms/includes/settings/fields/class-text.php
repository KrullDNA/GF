...
class Text extends Base {
	...
	public function markup() {
		...
		$html .= sprintf(
			...
			isset( $this->append ) ? sprintf( '<span class="kform-settings-field__text-append">%s</span>', esc_html( $this->append ) ) : '',
			$this->get_error_icon()
		);
...
Fields::register( 'text', '\KDNA_Forms\KDNA_Forms\Settings\Fields\Text' );
