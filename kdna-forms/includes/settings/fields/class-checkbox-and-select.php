...
class Checkbox_And_Select extends Base {
	...
	public function markup() {
		...
		$html .= sprintf(
			'<span class="%s">%s <span id="%s" class="kform-settings-input__target">%s %s</span></span>',
...
Fields::register( 'checkbox_and_select', '\KDNA_Forms\KDNA_Forms\Settings\Fields\Checkbox_and_Select' );
