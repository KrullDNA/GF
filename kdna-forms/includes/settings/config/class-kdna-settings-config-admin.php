 ...
 * @since 2.6.2
 */
class KDNA_Settings_Config_Admin extends KDNA_Config {
	...
	public function data() {
		$post_types = apply_filters( 'kdnaform_post_select_post_types', array( 'post', 'page' ) );
		$count      = apply_filters( 'kdnaform_post_select_initial_count', 5 );
	...
	public function get_first_users() {
		$first_users = array(
			array(
				'label' => esc_html__( 'Logged In User', 'kdnaforms' ),
		 ...
		 */
		$user_query_params = apply_filters( 'kdnaform_user_select_query_params', array( 'number' => 10 ) );
