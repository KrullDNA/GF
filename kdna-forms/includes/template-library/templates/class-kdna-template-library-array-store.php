...
/**
 * Class KDNA_Template_Library_Array_Store
 *
 * Loads the templates' library data from an array.
 *
 * @package KDNA_Forms\KDNA_Forms\Template_Library;
 */
class KDNA_Template_Library_Array_Store implements GF_Templates_Store {
	/**
	 * The templates array.
	 *
	 * @since 2.7
	 ...
	 *
	 * @return KDNA_Template_Library_Template|false
	 */
	public function get( $id ) {
		...
		return new KDNA_Template_Library_Template( $template_data );
	}
