...
namespace KDNA_Forms\KDNA_Forms\Template_Library\Endpoints;
...
use KDNA_Forms\KDNA_Forms\Template_Library\Templates\GF_Templates_Repository;
 ...
 * @since   2.7
 *
 * @package KDNA_Forms\KDNA_Forms\Template_Library\Endpoints
 */
class GF_Create_Form_Template_Library_Endpoint {
	...
	public function handle() {
		...
		if ( $this->template_id === 'blank' ) {
			$template = new KDNA_Template_Library_Template(
				array(
					'id'          => 'blank',
					'title'       => '',
					'description' => '',
		...
		if ( ! is_a( $template, KDNA_Template_Library_Template::class ) ) {
