...
class KDNA_Embed_Config extends KDNA_Config {
	...
	private function get_urls() {
		 ...
		 */
		$edit_link = apply_filters( 'kdnaform_embed_edit_post_link', $edit_link );
	...
	private function get_available_post_types() {
		 ...
		 * @return array
		 */
		return apply_filters( 'kdnaform_embed_post_types', $types );
	}
	...
	private function placeholder_post_types() {
		return array(
			array( 'slug' => 'page', 'label' => __( 'Page', 'kdnaforms' ) ),
			array( 'slug' => 'post', 'label' => __( 'Post', 'kdnaforms' ) ),
		);
	}
