...
class Block_Styles_Handler {
	...
	public function form_css_properties( $form_id, $settings, $block_settings, $form = array() ) {
		...
		return array(
			...
			'gf-ctrl-file-btn-bg-color-hover' => KDNACommon::darken_color( $color_palette['inside-control']['color-darker'], 2 ),
			...
			'gf-field-pg-steps-number-color' => 'rgba(' . implode( ', ', KDNACommon::darken_color( $applied_settings['labelColor'], 0, 'rgb' ) ) . ', 0.8)',
		);
	}
