		...
		return array(
			'components' => array(
				'author_select' => array(
					...
					'strings'        => array(
						'search_placeholder'  => esc_html__( 'Search users...', 'kdnaforms' ),
						'trigger_placeholder' => esc_html__( 'Select an author', 'kdnaforms' ),
						'trigger_aria_text'   => esc_html__( 'Default Post Author', 'kdnaforms' ),
						'search_aria_text'    => esc_html__( 'Search for users', 'kdnaforms' ),
					),
				),
			),
		);
