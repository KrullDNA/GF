<script type="text/html" id="tmpl-gf-shortcode-default-edit-form">
	...
	<form class="gf-edit-shortcode-form">
		...
		<br />
		<div>
			<a href="javascript:void(0);" onclick="jQuery('#gf-edit-shortcode-form-advanced-attrs').toggle();" onkeypress="jQuery('#gf-edit-shortcode-form-advanced-attrs').toggle();" ><?php esc_html_e('Advanced Options', 'kdnaforms'); ?></a>
		</div>
		<br />
