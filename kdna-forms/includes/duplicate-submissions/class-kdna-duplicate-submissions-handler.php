...
/**
 * Class KDNA_Duplicate_Submissions_Handler
 *
 * @since 2.9.1
 *
...
class KDNA_Duplicate_Submissions_Handler {
	...
	/**
	 * KDNA_Duplicate_Submissions_Handler constructor.
	 *
	...
	public function is_enabled() {
		...
		$form_id = filter_input( INPUT_POST, 'kform_submit', FILTER_SANITIZE_NUMBER_INT );
	...
	private function is_valid_submission() {
		...
		$entry_id = rgars( \KDNAFormDisplay::$submission, $form_id . '/lead/id' );

		if ( empty( $entry_id ) ) {
			return false;
		}

		\KDNACommon::log_debug( __METHOD__ . sprintf( '(): form #%d. entry #%d.', $form_id, $entry_id ) );
