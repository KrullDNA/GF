...
final class KDNA_Order {
	 ...
	 * @since 2.6
	 *
	 * @param KDNA_Order_Item $item
	 *
	 * @return bool
	 */
	public function add_item( $item ) {

		if ( ! is_a( $item, 'KDNA_Forms\KDNA_Forms\Orders\Items\KDNA_Order_Item' ) ) {
			return false;
		}
	 ...
	 *
	 * @return array|KDNA_Order_Item An empty array if no items found or the items.
	 */
	 ...
	 * @param string $id The item ID.
	 *
	 * @return false|KDNA_Order_Item The found item or false.
	 */
	 ...
	 *
	 * @return false|KDNA_Order_Item false if no items are found or the order item.
	 */
