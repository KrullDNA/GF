...
class KDNAExport {
	...
	private static function process_import_results( $all_results, $count ) {
		...
		if ( $total_forms > 1 ) {
			...
			$edit_links = "<a href='admin.php?page=gf_edit_forms&id={$form_ids}'>" . esc_html__( 'View imported forms.', 'kdnaforms' ) . '</a>';
			...
			$edit_links = "<a href='admin.php?page=gf_edit_forms&id={$forms_ids[0]}'>" . esc_html__( 'Edit form.', 'kdnaforms' ) . '</a>';
	...
	public static function import_form_page() {
        ...
        <div class="kdnaform-settings__content">
            <form method="post" enctype="multipart/form-data" class="kdnaform_settings_form">
                ...
                <div class="kdnaform-settings-panel kdnaform-settings-panel--full">
                    <header class="kdnaform-settings-panel__header"><legend class="kdnaform-settings-panel__title"><?php esc_html_e('Import Forms', 'kdnaforms'); ?></legend></header>
                    <div class="kdnaform-settings-panel__content">
                        <div class="kdnaform-settings-description">
							<?php
							echo sprintf(
	...
	public static function export_form_page() {
        ...
        <div class="kdnaform-settings__content">
            <form method="post" id="kdnaform_export" class="kdnaform_settings_form">
                ...
                <div class="kdnaform-settings-panel kdnaform-settings-panel--full">
                    <header class="kdnaform-settings-panel__header"><legend class="kdnaform-settings-panel__title"><?php esc_html_e( 'Export Forms', 'kdnaforms' )?></legend></header>
                    <div class="kdnaform-settings-panel__content">
                        <div class="kdnaform-settings-description">
	...
	public static function export_lead_page() {
        ...
        <div class="kdnaform-settings__content">
            <form method="post" id="kdnaform_export" class="kdnaform_settings_form" data-js="page-loader">
                ...
                <div class="kdnaform-settings-panel kdnaform-settings-panel--full">
                    <header class="kdnaform-settings-panel__header"><legend class="kdnaform-settings-panel__title"><?php esc_html_e( 'Export Entries', 'kdnaforms' ) ;?></legend></header>
                    <div class="kdnaform-settings-panel__content">
                        <div class="kdnaform-settings-description">
                        ...
                        <table class="form-table">
                            ...
                            <tr id="export_filter_container" valign="top" style="display: none;">
                                ...
                                <td>
                                    <div id="export_filters" class="kdnaform-settings-field__conditional-logic">
                                        <!--placeholder-->
                                    </div>
                                </td>
                            </tr>
