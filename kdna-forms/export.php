...
class KDNAExport {
	...
	private static function process_import_results( $all_results, $count ) {
		...
		if ( $total_forms > 1 ) {
			if ( $failed_forms_count > 0 ) {
				...
				printf(
					'<div class="kdna-notice notice notice-error">%s</div>',
					sprintf(
	...
	public static function import_form_page() {
		...
		self::page_header();
		?>
        <div class="kform-settings__content">
            <form method="post" enctype="multipart/form-data" class="kdnaform_settings_form">
                ...
                <div class="kform-settings-panel kform-settings-panel--full">
                    <header class="kform-settings-panel__header"><legend class="kform-settings-panel__title"><?php esc_html_e('Import Forms', 'kdnaforms'); ?></legend></header>
                    <div class="kform-settings-panel__content">
                        <div class="kform-settings-description">
							<?php
							echo sprintf(
	...
	public static function export_form_page() {
        ...
        <div class="kform-settings__content">
            <form method="post" id="kform_export" class="kdnaform_settings_form">
                ...
                <div class="kform-settings-panel kform-settings-panel--full">
                    <header class="kform-settings-panel__header"><legend class="kform-settings-panel__title"><?php esc_html_e( 'Export Forms', 'kdnaforms' )?></legend></header>
                    <div class="kform-settings-panel__content">
                        <div class="kform-settings-description">
	...
	public static function export_lead_page() {
        ...
        <div class="kform-settings__content">
            <form method="post" id="kform_export" class="kdnaform_settings_form" data-js="page-loader">
                ...
                <div class="kform-settings-panel kform-settings-panel--full">
                    <header class="kform-settings-panel__header"><legend class="kform-settings-panel__title"><?php esc_html_e( 'Export Entries', 'kdnaforms' ) ;?></legend></header>
                    <div class="kform-settings-panel__content">
                        <div class="kform-settings-description">
                        ...
                        <table class="form-table">
                            ...
                            <tr id="export_filter_container" valign="top" style="display: none;">
                                ...
                                <td>
                                    <div id="export_filters" class="kform-settings-field__conditional-logic">
                                        <!--placeholder-->
                                    </div>
                                </td>
                            </tr>
