		...
		<div class="wrap kforms_help <?php echo esc_attr( KDNACommon::get_browser_class() ); ?>">
            ...
            <form id="kdna_help_page_search" action="https://docs.kdnaforms.com" target="_blank">
                <div class="search_box">
                    ...
                    <button class="kform-button kform-button--size-r kform-button--white kform-button--width-auto kform-button--active-type-loader kform-button--loader-after kform-button--icon-trailing button_focus">
                        <span class="kform-button__text kform-button__text--inactive"><?php esc_html_e( 'Search', 'kdnaforms' ) ?></span>
                        <span class="screen-reader-text"><?php esc_html_e( '(opens in a new tab)', 'kdnaforms' ) ?></span>
                        <span class="kform-icon kform-icon--external-link kform-button__icon" aria-hidden="true"></span>
                    </button>
                </div>
            </form>
